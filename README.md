...
Hopefully osTicket is up and running without any issues. If there is any, feel free to contact me. Now let us be on our way to the next assignment: [osTicket post-install Configuration
](https://github.com/ddeloya101/osTicket---post-install-Configuration)
